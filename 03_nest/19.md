...
3. Para instalar o **SuperTest**, digite o comando abaixo:
...
**Linha 6:** Alterar **'AppController (e2e)'** por **'Testes do Módulo Tarefa (e2e)'**, para identificar o Módulo que será testado.
...
<div align="center"><img src="https://i.imgur.com/BS1jJu2.png" title="source: imgur.com" /></div>

Na sequência, vamos configurar o Banco de dados de teste **db_todolist_test**. Este Banco de dados será criado para evitar que os testes modifiquem os dados do Banco de dados principal da aplicação.

1. Abra o **MySQL Workbench**
2. Abra uma nova **Query** e digite o comando abaixo para criar o Banco de dados **db_todolist_test** e execute a query clicando no primeiro raio <img src="https://i.imgur.com/9FtJQlk.png" title="source: imgur.com" width="30px"/>.

```sql
CREATE DATABASE db_todolist_test;
```

3. Ao executar a query, será criado o **Banco de Dados**. Na janela **Navigator**, localizada no lado esquerdo da tela, será exibido o Banco de dados **db_todolist_test** na lista de **Schemas**, como mostra a imagem abaixo:

<div align="center"><img src="https://i.imgur.com/6dY6onq.png" title="source: imgur.com" width="50%"/></div>
...
<div align="center"><img src="https://i.imgur.com/PqoUbzl.png" title="source: imgur.com" /></div>
...
**Linha 19:** A propriedade **database** define o nome do Banco de dados que foi criado no MySQL (db_todolist_test)

**Linha 20:** A propriedade **autoLoadEntities** carregará todas as Classes Entidades, ou seja, ele procura todas Classes Entidade Registradas na **Classe AppModule** e cria as respectivas tabelas no Banco de dados **db_todolist_test**.
...
- O Banco de dados que será utilizado durante os testes (**db_todolist_test**), através do Método **TypeOrmModule.forRoot()**.
