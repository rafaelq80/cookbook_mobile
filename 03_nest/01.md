...
<h2>1. Desenvolvimento: Back-end, Front-end e Mobile</h2>
...
**Aplicativos móveis**, também abreviados de “**apps**”, ou aplicativos para celular, são os softwares que nos acompanham em nossos celulares e outros dispositivos móveis como tablets. Mas não só: há espaço para eles também nos smartwatches, smartTVs e quaisquer outros dispositivos inteligentes.

As atribuições de uma pessoa Desenvolvedora Mobile exigem multidisciplinaridades: design, experiência do usuário, conhecimentos em diferentes dispositivos e sistemas operacionais mobile (Android e iOS), diversas linguagens de programação (Mobile, Front-end e Back-end), testes de aplicativos e até mesmo o marketing para o lançamento.

Entre as principais Linguagens de Programação para aplicativos Mobile podemos destacar: o **Kotlin** e o **Flutter**. Abaixo vemos a tela de cadastro de um app Mobile que irá consumir os Recursos e os Endpoints de um Back-end.

<div align="center"><img src="https://i.imgur.com/kYBNszE.jpg" title="source: imgur.com" width="35%"/></div>

Uma aplicação mobile pode ser  **nativa,** criada exclusivamente para uma plataforma sob uma linguagem de programação específica ou pode ser **híbrida**, cujos códigos, ao fim do desenvolvimento, são compilados e exportados para que sejam  compatíveis tanto com o Android quanto o iOS. Além disso, ela pode ser desenvolvida com o objetivo de consumir uma API existente, desenvolvida em uma Linguagem Back-end como: Java, JasvaScript/TypeScript, .NET, entre outras, semelhante ao Front-end WEB.

Na ilustração abaixo vemos o app Mobile e o Back-end da aplicação funcionando de forma independente, se comunicando através da Internet, via requisições HTTP.

<div align="center"><img src="https://i.imgur.com/uasfF9d.jpg" title="source: imgur.com" /></div>

<h3>1.4. Pessoa Desenvolvedora Full Stack:</h3>
