<h1>Projeto 02 - Todo-List - Configurar o Banco de dados</h1>
...
2. Abra uma nova **Query** e digite o comando abaixo para criar o Banco de dados **db_todolist** e execute a query clicando no primeiro raio <img src="https://i.imgur.com/9FtJQlk.png" title="source: imgur.com" width="30px"/>.

```sql
CREATE DATABASE db_todolist;
```

3. Ao executar a query, será criado o **Banco de Dados**. Na janela **Navigator**, localizada no lado esquerdo da tela, será exibido o Banco de dados **db_todolist** na lista de **Schemas**, como mostra a imagem abaixo:

<div align="center"><img src="https://i.imgur.com/8s2qUY1.png" title="source: imgur.com" width="50%"/></div>

4. Caso o Banco de dados **db_todolist** não esteja aparecendo na lista, clique no botão <img src="https://i.imgur.com/YGV5zIh.png" title="source: imgur.com" width="4%"/> **Refresh**, localizado ao lado direito da palavra **Schemas**, na janela **Navigator**, como mostra a imagem abaixo:
...
Diferente do Projeto Hello World, no Projeto Todo-List vamos utilizar um Banco de dados para persistir os nossos Objetos, ou seja, gravar os dados dos Objetos como registros (linhas) nas Tabelas. 

Para começar, vamos configurar a conexão com o Banco de dados **db_todolist**.
...
<div align="center"><img src="https://i.imgur.com/7QRW8p0.png" title="source: imgur.com" /></div>

Vamos detalhar as alterações realizadas:

**Linha 2:** Importamos o pacote **TypeORMModule**, que foi instalado anteriormente

**Linha 6:** Inserimos o Módulo **TypeORMModule** dentro do array **imports**. Neste Módulo, através do Método **forRoot()** iremos configurar a conexão com o Banco de dados.
...
**Linha 12:** A propriedade **database** define o nome do Banco de dados que foi criado no MySQL (db_todolist)
...
**Linha 14:** A propriedade **synchronize** definida com true indica que as tabelas do Banco de dados serão criadas/atualizadas automaticamente em cada inicialização da aplicação. Essa opção está relacionada a estrutura das tabelas e não aos dados.
...
<div align="left"><img src="https://i.imgur.com/bQGvf3h.png" title="source: imgur.com" width="25px"/> <a href="https://github.com/rafaelq80/backend_todolist_nest/blob/02_configurar_typeorm/todolist/src/app.module.ts" target="_blank"><b>Código fonte da Classe AppModule</b></a>
...
1. Verifique se você está dentro da pasta do projeto **todolist**, como mostra a figura abaixo:

<div align="center"><img src="https://i.imgur.com/kXggbYz.png" title="source: imgur.com" /></div>

2. Digite o comando ***npm run start:dev***, para compilar e executar o projeto **todolist**. 
...
| **Unknown database 'db_todolist2'**                          | Banco de dados não encontrado. Verifique se você criou o Banco de dados no MySQL ou se o nome está correto. |

<br />

<div align="left"><img src="https://i.imgur.com/bQGvf3h.png" title="source: imgur.com" width="30px"/> <a href="https://github.com/rafaelq80/backend_todolist_nest/tree/02_configurar_typeorm" target="_blank"><b>Código fonte do projeto</b></a>
