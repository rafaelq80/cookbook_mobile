<h1>Projeto 02 - Blog Pessoal - Classe PostagemController e PostagemService - Método Apagar</h1>

O que veremos por aqui:

1. Criar o método apagar(id: number) na Classe PostagemService
2. Criar o método apagar(id: number) na Classe PostagemController
...
Vamos finalizar a construção das Classes **PostagemService** e  **PostagemController** implementando o Método **delete(id: number)**, que apagará um Objeto da Classe Postagem persistido no Banco de dados.
