...
| <img src="https://i.imgur.com/hOgWvSc.png" title="source: imgur.com" width="60px"/> | <p align="justify"> **ATENÇÃO:**  *A senha deve ter no mínimo 8 caracteres e pelo menos 1 letra maiúscula, 1 caracter especial e 1 numero*. </p> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
| <img src="https://i.imgur.com/hOgWvSc.png" title="source: imgur.com" width="80px"/> | <p align="justify"> **ATENÇÃO:**  *Conclua todas etapas do processo de criação da conta no Heroku antes de avançar para o próximo passo do Deploy*. </p> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
| <img src="https://i.imgur.com/hOgWvSc.png" title="source: imgur.com" width="100px"/> | <p align="justify"> **ATENÇÃO:**  *Não habilite em sua conta do Heroku a opção MFA (Multi-Factor Authentication), ou seja, o login em 2 etapas. Em alguns servidores não é possível efetuar login com o MFA habilitado*. </p> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
**Linha 23:** A propriedade **url** define o endereço do servidor, a porta, o usuario, a senha e o nome do banco de dados. Essa url será enviada pelo Heroku, por isso ela está sendo repassada com uma variável de ambiente.
...
<div align="center"><img  src="https://i.imgur.com/14aVxJU.png" title="source: imgur.com" /></div>

Caso o nome escolhido esteja disponível, será exibida a mensagem **is available** na cor verde.

| <img src="https://i.imgur.com/hOgWvSc.png" title="source: imgur.com" width="120px"/> | <p align="justify"> **ATENÇÃO:** O NOME DO PROJETO NÃO PODE CONTER LETRAS MAIUSCULAS, NUMEROS OU CARACTERES ESPECIAIS. ALÉM DISSO ELE PRECISA SER ÚNICO DENTRO DA PLATAFORMA HEROKU. </p> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
<div align="center"><img src="https://i.imgur.com/4sjcJqo.png" title="source: imgur.com" width="60%"/></div>

| <img src="https://i.imgur.com/hOgWvSc.png" title="source: imgur.com" width="80px"/> | <p align="justify"> **ATENÇÃO:** *Caso seja selecionado um plano diferente, o Heroku exigirá o Cartão de Crédito para emitir a fatura do serviço. </p> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
6. Em seguida, vamos procurar o **Repositório do Projeto Todo-List**

7. No item **Connect to Github**, na caixa de pesquisa **repo-name**, digite o **Nome do Repositório do Projeto Todo-List** e clique no botão **Search**.

<div align="center"><img src="https://i.imgur.com/w0rh7ng.png?1" title="source: imgur.com" /></div>

8. Será exibido o repositório. Clique no botão **Connect** ao lado do Repositório do Projeto Todo-List.

<div align="center"><img src="https://i.imgur.com/qai2HFK.png" title="source: imgur.com" /></div>

9. Observe que o Heroku indicará que a aplicação está **Conectada com o Repositório**.

<div align="center"><img src="https://i.imgur.com/hLGBA3p.png" title="source: imgur.com" /></div>
...
15. Outra forma de abrir a aplicação é digitando o endereço: **[https://nomedoprojeto.herokuapp.com](https://nomedoprojeto.herokuapp.com/)** no navegador. (No exemplo acima: https://mbnest.herokuapp.com)
...
2. Observe que o endereço do deploy será composto pelo **https://nomedoseuprojeto.herokuapp.com** . No Deploy feito neste material, o link ficou: **https://mbnest.herokuapp.com**, como mostra a imagem abaixo. 

<div align="center"><img src="https://i.imgur.com/qnWwxQl.png" title="source: imgur.com" /></div>
...
Como o Banco de dados criado no Heroku está vazio, precisamos inserir dados através do Insomnia. 
...
4. Na próxima janela, defina o nome da nova pasta como **Todo-List - Heroku**.

<div align="center"><img src="https://i.imgur.com/MAI8MDq.png" title="source: imgur.com" /></div>

5. Na pasta **Todo-List - Heroku**, altere o endereço de todas as Requisições para o endereço Remoto.
...
7. Altere o endereço local para o endereço Remoto: **https://mbnest.herokuapp.com/categorias/**), como mostra a imagem abaixo:

<div align="center"><img src="https://i.imgur.com/8HHUb9C.png" title="source: imgur.com" /></div>

8. Observe que **apenas o endereço do servidor foi alterado**, o endereço da Requisição permanece o mesmo.
9. Atualize o endereço de todas requisições da pasta **Todo-List - Heroku**, assim como foi feito na Requisição **Cadastrar Categoria**.
...
5. Ao finalizar o **git push**, o Heroku começará a refazer o Deploy automaticamente. Acompanhe o processo pelo Dashboard do Heroku. 
